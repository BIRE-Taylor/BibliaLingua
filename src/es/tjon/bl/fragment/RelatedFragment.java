...
public class RelatedFragment extends ListFragment
{
	...
	private static final String TAG = "es.tjon.bl.fragment.RelatedFragment";
	...
	public void scrollTo(String reference, boolean select)
	{
		...
		if(mActivity==null)
			return;
		if(mToast==null)
			mToast=Toast.makeText(mActivity,reference,Toast.LENGTH_SHORT);
		mToast.setText(reference);
		mToast.show();
	}
